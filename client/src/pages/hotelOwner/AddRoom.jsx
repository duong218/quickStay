        ...
        <form onSubmit={onSubmitHandler}>
            ...
            <div className='grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap'>
                {Object.keys(images).map((key) => (
                    <label key={key} htmlFor={`roomImage${key}`}>
                        <img className='max-h-13 cursor-pointer opacity-80 hover:opacity-100 transition-opacity' src={images[key] ? URL.createObjectURL(images[key]) : assets.uploadArea} alt="" />
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                ...
                <div className='flex-1 max-w-48'>
                    ...
                    <select className='border opacity-70 border-gray-300 mt-1 rounded p-2 w-full focus:border-primary focus:outline-none' value={inputs.roomType} onChange={(e) => setInputs({ ...inputs, roomType: e.target.value })}>
                ...
                <div>
                    ...
                    <input type="number" placeholder='0' className='border border-gray-300 mt-1 rounded p-2 w-24 focus:border-primary focus:outline-none' value={inputs.pricePerNight} onChange={(e) => setInputs({ ...inputs, pricePerNight: e.target.value })} />
                </div>
